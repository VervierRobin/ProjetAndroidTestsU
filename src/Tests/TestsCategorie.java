...
public class TestsCategorie {
	...
	public void testCat() {
		...
		UtilisateurDB user1 = new UtilisateurDB("Lebleu", "Marie", "1854854",
				"LM", "147852");
		UtilisateurDB user2 = new UtilisateurDB("Lerouge", "Thérèse",
		...
		/**
		 * Test d'ajout d'une communauté (plusieurs communaute même nom
		 * categorie)
		 */
		try {
			System.out
					.println("\n> test ajout (plusieurs communaute même nom categorie)");
			cat1 = new CategorieDB("Rendez-vous", commu1);
			cat1.create();
		...
		try {
			...
			cat2.create();
			System.err
					.println("BAD Catégorie avec nom identique dans une même communauté ");
		} catch (Exception e) {
        ...
        try {
            ...
            System.out.println("cat2=" + cat2);
            cat1.delete();
            System.out.println("BAD Catégorie avec nom identique");
        } 
        catch (Exception e) {
        	System.out.println("OK exception normale de doublon : " + e);
        }
         ...
         /**
          * Test de mise à jour (Nouveau nom existant dans communauté diférente)
          */
         try {
        	 System.out.println("\n> test mise à jour infructueux (Nouveau nom existant communauté différent)");
